...
namespace D2net.Common.UI
{
	...
	public class FlatTabControl : System.Windows.Forms.TabControl
	{
        ...
        private Bitmap _CtrlPanel = null;
        private Color _TabBorderColor = SystemColors.ControlDark;
        private Pen _BorderPen = null;
        private bool _ShowUpBorderOnly = false;
        private Color _SelectedColor = SystemColors.ControlLightLight;
		...
		public FlatTabControl()
		{
            ...
            _BorderPen = new Pen(_TabBorderColor);
            RemakeControlImage();
		...
		protected override void OnPaint(PaintEventArgs e)
		{
            ...
            if (_CtrlPanel != null)
            {
                g = Graphics.FromImage(_CtrlPanel);
                DrawControl(g);
                e.Graphics.DrawImage(_CtrlPanel, 0, 0);
            }
            else
		...
		internal void DrawControl(Graphics g)
		{
            ...
            if (!_ShowUpBorderOnly)
			    g.DrawRectangle(_BorderPen, TabArea);
			//----------------------------
            ...
            if (_ShowUpBorderOnly &&
                this.TabPages.Count > 0 &&
                this.SelectedTab != null)
            {
                Rectangle SelectedRect = GetTabRect(this.SelectedIndex);
                g.DrawLine(_BorderPen, 0, SelectedRect.Bottom, SelectedRect.Left, SelectedRect.Bottom);
                g.DrawLine(_BorderPen, SelectedRect.Right, SelectedRect.Bottom, Width, SelectedRect.Bottom);
            }
		}
		...
		internal void DrawTab(Graphics g, TabPage tabPage, int nIndex)
		{
            ...
            if (this.SelectedIndex == nIndex)
			    br = new SolidBrush(_SelectedColor);
            else
			...
			g.DrawString(tabPage.Text, 
                Font, 
                br, 
                new RectangleF(tabTextArea.X, tabTextArea.Y + 4, tabTextArea.Width, tabTextArea.Height - 2), 
                stringFormat);
			//----------------------------
		}
        ...
        private void RemakeControlImage()
        {
            Bitmap oldBmp = _CtrlPanel;
            _CtrlPanel = new Bitmap(Width, Height);
            if (oldBmp != null)
                oldBmp.Dispose();
            oldBmp = null;
        }
        ...
        [Browsable(true)]
        public bool ShowUpBorderOnly
        {
            get {return _ShowUpBorderOnly;}
            set
            {
                _ShowUpBorderOnly = value;
                this.Invalidate();
            }
        }
        #endregion
        ...
        protected override void OnTabIndexChanged(EventArgs e)
        {
            ...
            if (_OldSelectedIndex >= 0)
                this.TabPages[_OldSelectedIndex].BackColor = this.BackColor;
            
            this.TabPages[this.SelectedIndex].BackColor = _SelectedColor;
            _OldSelectedIndex = this.SelectedIndex;
            this.Invalidate();
        }
	}
