...
function make_calendar(y,m,d)
{
    ...
    if(isIe)
    {
      ...
      else
      {
    	 ...
    	 content=content + "<span style='font-size: 8px;font-family:tahoma,verdana; color:blue; text-decoration:none; cursor:hand' font-weight:bold' onClick='parent.showCalendarPopup(" + (y-1) + "," + m + "," + day + ");' ><img src=/images/common/d_prev.gif align=absmiddle></span>" + y;
    	 content=content + "<span style='font-size: 8px;font-family:tahoma,verdana; color:blue; text-decoration:none; cursor:hand' onClick='parent.showCalendarPopup(" + (y+1) + "," + m + "," + day + ");' ><img src=/images/common/d_next.gif align=absmiddle>&nbsp;</span>";
    	 content=content + "<span style='font-size: 8px;font-family:tahoma,verdana; color:blue; text-decoration:none; cursor:hand' onClick='parent.showCalendarPopup(" + y + "," + (m-1) + "," + day + ");' >&nbsp;<img src=/images/common/d_prev.gif align=absmiddle></span>" + m;
    	 content=content + "<span style='font-size: 8px;font-family:tahoma,verdana; color:blue; text-decoration:none; cursor:hand' onClick='parent.showCalendarPopup(" + y + "," + (m+1) + "," + day + ");' ><img src=/images/common/d_next.gif align=absmiddle></span>";
