...
@Component("audioTranscodeControlWorker")
public class AudioTranscodeControlWorker implements Worker {
	...
	public void work() {
		...
		try {
			...
			logger.error("[Transcode Audio Job Control] TransferJobSwap Error", e);
		}
