...
public class NavigatorProxy implements kr.co.d2net.gate2.soap.Navigator {
  private String _endpoint = null;
  private kr.co.d2net.gate2.soap.Navigator navigator = null;
  ...
  private void _initNavigatorProxy() {
    try {
      navigator = (new kr.co.d2net.gate2.soap.ServiceNavigatorServiceLocator()).getServiceNavigatorPort();
      if (navigator != null) {
        if (_endpoint != null)
  ...
  public kr.co.d2net.gate2.soap.Navigator getNavigator() {
    if (navigator == null)
      _initNavigatorProxy();
    return navigator;
  }
